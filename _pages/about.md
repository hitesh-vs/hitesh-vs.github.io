...
<div style="border-left: 3px solid #999; padding-left: 20px; margin-top: 20px;">
  ...
  <div style="margin-bottom: 25px;">
    <h4 style="margin-bottom: 5px;"><strong>Robotics Simulations and AI Co-Op</strong></h4>
    <p style="margin: 0;">Piaggio Fast Forward | Boston, MA, USA</p>
    <p style="margin: 0; color: gray;">Jul 2025 - Dec 2025</p>
  </div>

  <div style="margin-bottom: 25px;">
    <h4 style="margin-bottom: 5px;"><strong>Undergraduate Research Assistant</strong></h4>
    <p style="margin: 0;">Robotics Research Center, IIIT Hyderabad | Hyd, India</p>
    <p style="margin: 0; color: gray;">Jul 2023 - Dec 2023</p>
  </div>
...
<div style="display: flex; flex-direction: column; gap: 25px; margin-top: 25px;">
  ...
  <div style="display: flex; align-items: center; gap: 20px;">
    ...
    <img src="/assets/img/wpilogo.png"
         style="width: 70px; height: 70px; object-fit: contain; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
  ...
  <div style="display: flex; align-items: center; gap: 20px;">
    ...
    <img src="/assets/img/bits_logo.png"
         style="width: 70px; height: 70px; object-fit: contain; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
